...
/**
 * This is a model class for CreateTriggerV2Request type.
 */
public class CreateTriggerV2Request {
    ...
    /**
     * Converts this CreateTriggerV2Request into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CreateTriggerV2Request [" + "triggerName=" + triggerName + ", ecpdId=" + ecpdId
                + ", deviceGroupName=" + deviceGroupName + ", triggerCategory=" + triggerCategory
                + ", pricePlanTrigger=" + pricePlanTrigger + ", notification=" + notification
                + ", active=" + active + "]";
    }

    /**
     * Builds a new {@link CreateTriggerV2Request.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateTriggerV2Request.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateTriggerV2Request}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateTriggerV2Request} object using the set fields.
         * @return {@link CreateTriggerV2Request}
         */
        public CreateTriggerV2Request build() {
            return new CreateTriggerV2Request(triggerName, ecpdId, deviceGroupName, triggerCategory,
