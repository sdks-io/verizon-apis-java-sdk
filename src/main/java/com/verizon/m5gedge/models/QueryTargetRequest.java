...
public class QueryTargetRequest {
    ...
    public String toString() {
        return "QueryTargetRequest [" + "accountidentifier=" + accountidentifier + ", selection="
                + selection + ", resourceidentifier=" + resourceidentifier + "]";
    }
    ...
    public static class Builder {
        ...
        public QueryTargetRequest build() {
            return new QueryTargetRequest(accountidentifier, selection, resourceidentifier);
        }
    }
}
