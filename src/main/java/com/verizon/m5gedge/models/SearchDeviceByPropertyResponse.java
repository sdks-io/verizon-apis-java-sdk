...
public class SearchDeviceByPropertyResponse {
    ...
    public static class Builder {
        ...
        public SearchDeviceByPropertyResponse build() {
            return new SearchDeviceByPropertyResponse(billingaccountid, createdon, eventretention,
                    fields, iccid, id, imei, kind, lastupdated, providerid, refid, refidtype, state,
                    version, versionid);
        }
    }
}
