...
public final class DeviceServiceManagementController extends BaseController {
     ...
     * @param  imei  Required parameter: The International Mobile Equipment Identifier of the
     *         device.
     * @param  accountNumber  Required parameter: The numeric name of the account and must include
     *         leading zeroes.
