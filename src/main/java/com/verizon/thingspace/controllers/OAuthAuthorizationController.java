...
import com.verizon.thingspace.exceptions.OAuthProviderException;
...
public final class OAuthAuthorizationController extends BaseController {
     ...
     */
    public OAuthToken requestTokenThingspaceOauth(
     ...
     * @return    Returns the OAuthToken response from the API call
     */
    public CompletableFuture<OAuthToken> requestTokenThingspaceOauthAsync(
            final String authorization,
            final String scope,
     ...
     */
    private ApiCall<OAuthToken, ApiException> prepareRequestTokenThingspaceOauthRequest(
            final String authorization,
            final String scope,
