...
public class GIOProfileRequest {
     ...
     * @param  smrsOid  String value for smrsOid.
     ...
     * The Subscription Manager Secure Router Object ID, used for remote SIM provisioning. SMSR
     * securely routes the download and management of eSIM profiles.
     * @param smrsOid Value for String
     */
    @JsonSetter("smrsOid")
    public void setSmrsOid(String smrsOid) {
        this.smrsOid = smrsOid;
    }
    ...
    public String toString() {
        return "GIOProfileRequest [" + "devices=" + devices + ", accountName=" + accountName
                + ", smrsOid=" + smrsOid + ", mdnZipCode=" + mdnZipCode + ", servicePlan="
                + servicePlan + "]";
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder smrsOid(String smrsOid) {
            this.smrsOid = smrsOid;
            return this;
        }
        ...
        public GIOProfileRequest build() {
            return new GIOProfileRequest(devices, accountName, smrsOid, mdnZipCode, servicePlan);
        }
    }
}
