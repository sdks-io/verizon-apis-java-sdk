...
public class TriggersListOptions {
    ...
    private List<TriggerAttributesOptions2> triggerAttributes;
     ...
     * @param  triggerAttributes  List of TriggerAttributesOptions2 value for triggerAttributes.
    ...
    public TriggersListOptions(
            ...
            List<TriggerAttributesOptions2> triggerAttributes,
            String createdAt,
            String modifiedAt,
     ...
     * @return Returns the List of TriggerAttributesOptions2
     */
    @JsonGetter("triggerAttributes")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<TriggerAttributesOptions2> getTriggerAttributes() {
     ...
     * Additional details and keys for the trigger.
     * @param triggerAttributes Value for List of TriggerAttributesOptions2
     */
    @JsonSetter("triggerAttributes")
    public void setTriggerAttributes(List<TriggerAttributesOptions2> triggerAttributes) {
        this.triggerAttributes = triggerAttributes;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder triggerAttributes(List<TriggerAttributesOptions2> triggerAttributes) {
            this.triggerAttributes = triggerAttributes;
            return this;
        }
