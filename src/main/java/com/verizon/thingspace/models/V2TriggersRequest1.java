...
import com.verizon.thingspace.models.containers.V2TriggersRequest1SmsNumbers;
...
public class V2TriggersRequest1 {
    ...
    private List<V2TriggersRequest1SmsNumbers> smsNumbers;
     ...
     * @param  smsNumbers  List of V2TriggersRequest1SmsNumbers value for smsNumbers.
    ...
    public V2TriggersRequest1(
            ...
            List<V2TriggersRequest1SmsNumbers> smsNumbers,
            Boolean reminder,
            String severity,
            ActiveEnum active,
            String accountName,
     ...
     * @return Returns the List of V2TriggersRequest1SmsNumbers
     */
    @JsonGetter("smsNumbers")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<V2TriggersRequest1SmsNumbers> getSmsNumbers() {
        return smsNumbers;
    }

    /**
     * Setter for SmsNumbers.
     * @param smsNumbers Value for List of V2TriggersRequest1SmsNumbers
     */
    @JsonSetter("smsNumbers")
    public void setSmsNumbers(List<V2TriggersRequest1SmsNumbers> smsNumbers) {
        this.smsNumbers = smsNumbers;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder smsNumbers(List<V2TriggersRequest1SmsNumbers> smsNumbers) {
            this.smsNumbers = smsNumbers;
            return this;
        }
        ...
        public V2TriggersRequest1 build() {
            return new V2TriggersRequest1(triggerId, triggerName, ecpdId, triggerCategory,
