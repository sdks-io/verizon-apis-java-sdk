 ...
 */
@JsonDeserialize(using = DataTrigger5Condition.DataTrigger5ConditionDeserializer.class)
public abstract class DataTrigger5Condition {
     ...
     */
    public static DataTrigger5Condition fromConditionObjectCall(
    ...
    private static class ConditionTypeCase extends DataTrigger5Condition {
    ...
    private static class ConditionObjectCallCase extends DataTrigger5Condition {
    ...
    /**
     * This is a custom deserializer class for DataTrigger5Condition.
     */
    protected static class DataTrigger5ConditionDeserializer
            extends JsonDeserializer<DataTrigger5Condition> {

        @Override
        public DataTrigger5Condition deserialize(JsonParser jp, DeserializationContext ctxt)
