 ...
 */
@JsonDeserialize(using = PricePlanTrigger1Condition.PricePlanTrigger1ConditionDeserializer.class)
public abstract class PricePlanTrigger1Condition {
     ...
     */
    public static PricePlanTrigger1Condition fromConditionObjectCall(
    ...
    private static class ConditionTypeCase extends PricePlanTrigger1Condition {
    ...
    private static class ConditionObjectCallCase extends PricePlanTrigger1Condition {
    ...
    /**
     * This is a custom deserializer class for PricePlanTrigger1Condition.
     */
    protected static class PricePlanTrigger1ConditionDeserializer
            extends JsonDeserializer<PricePlanTrigger1Condition> {

        @Override
        public PricePlanTrigger1Condition deserialize(JsonParser jp, DeserializationContext ctxt)
