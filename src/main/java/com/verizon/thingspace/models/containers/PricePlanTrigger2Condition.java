 ...
 */
@JsonDeserialize(using = PricePlanTrigger2Condition.PricePlanTrigger2ConditionDeserializer.class)
public abstract class PricePlanTrigger2Condition {
     ...
     */
    public static PricePlanTrigger2Condition fromConditionObjectCall(
    ...
    private static class ConditionTypeCase extends PricePlanTrigger2Condition {
    ...
    private static class ConditionObjectCallCase extends PricePlanTrigger2Condition {
    ...
    /**
     * This is a custom deserializer class for PricePlanTrigger2Condition.
     */
    protected static class PricePlanTrigger2ConditionDeserializer
            extends JsonDeserializer<PricePlanTrigger2Condition> {

        @Override
        public PricePlanTrigger2Condition deserialize(JsonParser jp, DeserializationContext ctxt)
