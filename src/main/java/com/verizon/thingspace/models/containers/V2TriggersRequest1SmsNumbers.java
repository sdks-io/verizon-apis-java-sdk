 ...
 */
@JsonDeserialize(using = V2TriggersRequest1SmsNumbers.V2TriggersRequest1SmsNumbersDeserializer.class)
public abstract class V2TriggersRequest1SmsNumbers {
     ...
     */
    public static V2TriggersRequest1SmsNumbers fromCellphonenumber(
    ...
    private static class CellphonenumberCase extends V2TriggersRequest1SmsNumbers {
    ...
    /**
     * This is a custom deserializer class for V2TriggersRequest1SmsNumbers.
     */
    protected static class V2TriggersRequest1SmsNumbersDeserializer
            extends JsonDeserializer<V2TriggersRequest1SmsNumbers> {

        @Override
        public V2TriggersRequest1SmsNumbers deserialize(JsonParser jp, DeserializationContext ctxt)
