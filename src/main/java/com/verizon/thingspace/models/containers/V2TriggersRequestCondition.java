 ...
 */
@JsonDeserialize(using = V2TriggersRequestCondition.V2TriggersRequestConditionDeserializer.class)
public abstract class V2TriggersRequestCondition {
     ...
     */
    public static V2TriggersRequestCondition fromConditionObjectCall(
    ...
    private static class ConditionTypeCase extends V2TriggersRequestCondition {
    ...
    private static class ConditionObjectCallCase extends V2TriggersRequestCondition {
    ...
    /**
     * This is a custom deserializer class for V2TriggersRequestCondition.
     */
    protected static class V2TriggersRequestConditionDeserializer
            extends JsonDeserializer<V2TriggersRequestCondition> {

        @Override
        public V2TriggersRequestCondition deserialize(JsonParser jp, DeserializationContext ctxt)
